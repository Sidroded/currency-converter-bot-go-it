...
public class ChooseOperationTypeCommand {
    ...
    private static InlineKeyboardMarkup setInclineKeyboardMarkupOfOperationType(User user){
        ...
        usdButton.setText(ButtonText.USD_CURRENCY_BUTTON_TEXT + getEmoji(OperationType.UAH_TO_USD,user).get());
        ...
        eurButton.setText(ButtonText.EUR_CURRENCY_BUTTON_TEXT + getEmoji(OperationType.UAH_TO_EUR,user).get());
